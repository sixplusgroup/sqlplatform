...
CREATE TABLE `matches`  (
  ...
  `first_player` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `second_player` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
