...
public class EvoSQLConfiguration {
	...
	public static double MUTATE_NULL_PROBABILITY = 0.1; 

	public static double SEED_INSERT_PROBABILITY = 0.5;
	public static double SEED_CHANGE_PROBABILITY = 0.5;
	...
	/** Evaluation time **/
	public static long MS_EXECUTION_TIME = 5000; // 2 min = 120000, 5 min = 300000, Half an hour = 1800000 ms
