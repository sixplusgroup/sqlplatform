...
public class QueryLevelData implements Comparator<QueryLevelData> {
	...
	public int compare(QueryLevelData qld1, QueryLevelData qld2) {
		...
		if (qld1.subLevelData != null && qld2.subLevelData != null) {
			...
			// QLD2 has no sub level data, QLD1 does, qld1 is better
			return -1;
		} else if (qld2.subLevelData != null) {
			// QLD1 has no sub level data, QLD2 does, qld2 is better
			return 1;
		}
	...
	public String toString() {
		StringBuilder result = new StringBuilder("{" + getQueryLevel() + ", " + getMaxRangeVariableIndex() + ", " + getDistance());
	...
	public boolean equals(Object o) {
		...
		if (!Objects.equals(prevLevelData, that.prevLevelData))
			return false;
		return Objects.equals(subLevelData, that.subLevelData);
	}
